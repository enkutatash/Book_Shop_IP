...
<i class="fa fa-bars"></i>
        ...
        <fieldset class="form">
            ...
            <form action="<?php echo (empty($error_message) && isset($name) && isset($email) && isset($phone) && isset($pass) && isset($cpass)) ? '../backend/signup.php' : ''; ?>" method = 'POST'>
                ...
                <?php endif; ?>
                <input type="text" placeholder="Phone" name="phone" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : ''; ?>">
            ...
            <span class="span">Already have an account? <a href="./signin.php">Sign In</a> </span>
