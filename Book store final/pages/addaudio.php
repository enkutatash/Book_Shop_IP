...
<body>
    ...
    <header>
        ...
        <fieldset class="form">
            ...
            <form action="<?php echo (empty($error_message) && isset($name) && isset($price) && isset($coverimage) && isset($booksample) && isset($book)) ? '../backend/audioadd.php' : ''; ?>" enctype="multipart/form-data" method = 'POST'>
